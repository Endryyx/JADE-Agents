			...
			case 3:      
				...
				break;
                        ...
                        case 7:
                            ...
                            if(potenciaDemanda==1655){
                                potenciaDemanda=1655;
                            }
                                           ...
                                           if(numreplybatt<=this.numOrderBatt){
                                               ...
                                               agentBatts=battData.DataStorage_batt(this.numOrderBatt, reply_batt.getSender(), p_batt, soc_batt, 0);
                                                  ...
                                                  if(pcc_>controlP_batts.pcc_upper){
                                                      ...
                                                      System.out.println(reply_batt.getSender().getName()+" se detiene para evitar el conflicto con el límite superior de PeakShaving :"+controlP_batts.pcc_upper);  
                                                  }else{
                                           ...
                                           if(numreplybatt==this.numOrderBatt){
                                               ...
                                               if(pcc_<controlP_batts.pcc_lower && aCD_!=0){
                                                  ...
                                                  while(pcc_<controlP_batts.pcc_lower){
                                                      ...
                                                      System.out.println(agentBatts[numreplybatt-i].GetArrayAgent_AID()+" se detiene para evitar el conflicto con el límite inferior de PeakShaving :"+controlP_batts.pcc_lower);
                                            ...
                                            if(numreplybatt<=this.numOrderBatt){
                                                ...
                                                agentBatts=battData.DataStorage_batt(this.numOrderBatt, reply_batt.getSender(), p_batt, soc_batt, 0);
                                                  ...
                                                  if(pcc_<controlP_batts.pcc_lower){
                                                      //Entra en conflicto por limite superior
                                                      System.out.println(reply_batt.getSender().getName()+" se detiene para evitar el conflicto con el límite inferior de PeakShaving :"+controlP_batts.pcc_lower);  
                                                  }else{
                                                     //Si no entra en conflicto
                                                    if(aCD_==1){
                                                        System.out.println(p_batt+"(kW) "+"consume "+reply_batt.getSender().getName()+" mediante fase de carga automática.\n");
