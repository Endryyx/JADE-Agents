            ...
            public void action(){
               ...
               try {
                    ...
                    if(result.length>0){
                        ...
                        System.out.println("No se contactado con ningún consumidor.\n ");
                         //System.out.println("No se encontrado con ningún consumidor.\n Por favor, agregue algún consumidor y vuelva a crear un agente Power Manager. ");
                         //myAgent.doDelete();
                         block();
            ...
            public void action(){
               ...
               demand_point = myAgent.receive(mt);
                ...
                if (demand_point!=null){
                    ...
                    if(j>=AgentesConsumidores.length-1){
                        
                        pDemanda=pDemanda+Float.parseFloat(potenciaDemanda_Str);
                        potenciaDemanda_Str=Float.toString(pDemanda);
                        myAgent.addBehaviour(new GenerationBehaviour());
                        j=0;
                        i=0;
                        //d_point++;
                        
                    }else{ //Si es menor al numero de agentes consumidores
...
/*Behaviour that initialize the operation*/
        private class GenerationBehaviour extends Behaviour{
            ...
            public void action(){
                ...
                System.out.println("Necesito una potencia de generacion igual a "+pDemanda);
				...
				ACLMessage order = new ACLMessage(ACLMessage.ACCEPT_PROPOSAL);
                               ...
                               this.potenciaGenerada=potenciaGenerada;
                                for(i=0;i<numOrderDemand;i++){
                                    //************PODRIA SER NECESARIO INCLUIR ESTA SENTECIA*******************
                                    //ACLMessage order = new ACLMessage(ACLMessage.ACCEPT_PROPOSAL);
