...
/*Behaviour that initialize the operation*/
	...
	private class SolicitudCompra extends Behaviour {
		...
		public void action() {
                    ...
                    float aCD=0;//Automatic Charge and Discharge
                    String batt_input,batt_output;
                    String p_diff,status,threshold;
                            ...
                            pcc_initial_=potenciaDemanda-this.potenciaGenerada;
                                ...
                                if (reply_batt != null) {
                                    ...
                                    if (reply_batt.getPerformative() == ACLMessage.PROPOSE) {
                                        ...
                                        //Deficit de energía, no se ha cubierto la demanda
                                        if (pcc_initial_>0){
                                            if(aCD==0 || aCD==-1){//Si no hay carga ni descarga automatica o descarga automatica
                                                if(p_batt<0){p_batt=-p_batt;}
